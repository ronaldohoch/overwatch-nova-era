...
type HeroQuote = { hero: string; text: string };

@Component({
  selector: 'ow-random-hero-quote',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <h2 class="text-4xl md:text-5xl font-black uppercase mb-6 relative">
      ...
      <span class="italic relative z-10">{{ quote.text }}</span>
      <span class="block text-[#d8530d]"> {{ quote.hero }}</span>
    </h2>
  `,
})
export class OwRandomHeroQuoteComponent {
  private readonly quotes: readonly HeroQuote[] = [
    { hero: 'Ana', text: 'Não vou deixar um mundo partido pra trás.' },
    { hero: 'Baptiste', text: 'Outro dia, outro campo de batalha.' },
    { hero: 'Brigitte', text: 'Quanto mais eu sofro, mais me fortaleço.' },
    { hero: 'Cassidy', text: 'Alguém tem que montar nessa sela.' },
    { hero: 'D.Va', text: 'Hora de salvar o mundo? Bora lá!' },
    { hero: 'Echo', text: 'Estou sempre pronta para aprender.' },
    { hero: 'Hanzo', text: 'A vingança é tudo que me resta.' },
    { hero: 'Kiriko', text: 'Eu vou encontrar o meu próprio caminho.' },
    { hero: 'Lúcio', text: 'A gente chegou pra esculachar!' },
    { hero: 'Mercy', text: 'Não se preocupem, estarei atrás de vocês.' },
    { hero: 'Moira', text: 'A humanidade está acorrentada. Eu encontrarei a chave.' },
    { hero: 'Orisa', text: 'A força reside na união.' },
    { hero: 'Reinhardt', text: 'Nós os derrubaremos!' },
    { hero: 'Sigma', text: 'Por que buscar respostas quando não sabemos a pergunta?' },
    { hero: 'Sojourn', text: 'Estamos nessa juntos. Todos nós.' },
    { hero: 'Symmetra', text: 'Da imperfeição, construiremos um novo mundo.' },
    { hero: 'Winston', text: 'Um mundo melhor é possível hoje.' },
    { hero: 'Zenyatta', text: 'Em meio à discórdia, encontraremos a tranquilidade.' },
  ];

  readonly quote: HeroQuote = this.pickRandom(this.quotes);
